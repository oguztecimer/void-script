...
- [ ] 01-03-PLAN.md — Gap closure: fix traffic light window controls (minimize/maximize crash)
...
Plans:
- [x] 06-01-PLAN.md — NavPath breadcrumb, DiagnosticsWidget icons, remove VCS branch
- [x] 06-02-PLAN.md — Gap closure: fix StatusBar flex-shrink collapse (all 7 UAT failures)
...
- [ ] 09-03-PLAN.md — Gap closure: breadcrumb cursor sync (cursorLine reset on tab open/switch, initial setCursor after EditorView creation)
- [ ] 09-04-PLAN.md — Gap closure: tooltip horizontal viewport clamping (offsetX correction for left/right edge clipping)
...
|-------|----------------|--------|-----------|
| 1. Foundation | 2/3 | Gap closure   | 2026-03-14 |
...
| 9. Polish and Tooltips | 4/4 | Complete   | 2026-03-15 |
