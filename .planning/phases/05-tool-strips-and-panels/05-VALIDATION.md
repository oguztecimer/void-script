...
| 05-02-01 | 02 | 1 | PNLS-03 | manual + tsc | `npx tsc --noEmit` | N/A | ⬜ pending |
| 05-03-01 | 03 | 1 | PNLS-04 | manual + tsc | `npx tsc --noEmit` | N/A | ⬜ pending |
...
| Panel headers with title + action icons | PNLS-02 | Visual layout verification | Inspect ScriptList, DebugPanel, Console headers in browser |
